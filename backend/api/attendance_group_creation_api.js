const Site = require('../models/attendance_group_creation')
...
async function list_by_client_admin_id(req, res, next) {
    const products1 = await Site.list_by_client_admin_id(req.body.client_admin_id)
    res.json(products1)
}

async function list_by_site_admin_id(req, res, next) {
    const products1 = await Site.list_by_site_admin_id(req.body.site_admin_id)
    res.json(products1)
}
