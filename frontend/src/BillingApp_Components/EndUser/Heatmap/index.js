...
export default function Events() {
    ...
    const [time_chk, settime_chk] = useState('day')
                                ...
                                <Col xl={12} lg={12} md={12} sm={12} xs={12} id='events' style={{ backgroundColor: '#e6e8eb', position: 'sticky', top: 0, zIndex: 2 }}>
                                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                        <div style={{ display: select === false ? 'block' : 'none' }}>
                                            <div id='eventsDiv' style={{ display: 'flex', marginLeft: page === 1 ? '0px' : '10px', marginBottom: '10px' }}>
                                                                    ...
                                                                    <div style={{ borderRadius: '5px', backgroundColor: '#181828', padding: '10px', position: 'absolute', top: '60px', zIndex: 1, boxShadow: 'rgba(0, 0, 0, 0.35) 0px 5px 15px', width: '200px', display: create_group_select ? 'block' : 'none' }}>
                                                                        <div style={{ position: 'relative' }}>
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
                                                                                    <p style={{ margin: 0, color: 'white', fontWeight: 'bolder', marginBottom: '0px', marginRight: '10px' }}>Weekly</p>
                                                                                    <input type='checkbox' checked={time_chk == 'week' ? true : false} onChange={(e) => {
                                                                                        const date_start = startdate.split('-')
                                                                                        const startOfMonth = moment([date_start[0], date_start[1] == 0 ? date_start[1] : date_start[1] - 1]);
                                                                                        const firstSunday = startOfMonth.clone().startOf('month').day(0);
                                                                                        if (firstSunday.month() !== startOfMonth.month()) {
                                                                                            firstSunday.add(1, 'week');
                                                                                        }

                                                                                        console.log(firstSunday.format('YYYY-MM-DD'));
                                                                                        console.log(startdate);

                                                                                        dispatch({ type: STARTDATE, value: firstSunday.format('YYYY-MM-DD') })
                                                                                        dispatch({ type: ENDDATE, value: firstSunday.format('YYYY-MM-DD') })
                                                                                        let crt_splt = firstSunday.format('YYYY-MM-DD').split('-')
                                                                                        setstart_dateFullYear(crt_splt[0])
                                                                                        setstart_dateMonth(crt_splt[1])
                                                                                        setstart_dateDate(crt_splt[2])
                                                                                        setend_dateFullYear(crt_splt[0])
                                                                                        setend_dateMonth(crt_splt[1])
                                                                                        setend_dateDate(crt_splt[2])
                                        ...
                                        setclickbtn1(true)
                                                    ...
                                                    {cameras.length != 0 ? (
                                                        ...
                                                        }}> <CalendarMonthIcon style={{ marginRight: '7px' }} />{`${start_dateFullYear}${time_chk != 'yearly' ? `-${start_dateMonth}` : ''}${time_chk == 'monthly' || time_chk == 'yearly' ? '' : `-${start_dateDate}`}`} {time_chk == 'monthly' || time_chk == 'yearly' || time_chk == 'week' || time_chk == 'day' ? '' : `(${starttime})`} - {`${end_dateFullYear}${time_chk != 'yearly' ? `-${end_dateMonth}` : ''}${time_chk == 'monthly' || time_chk == 'yearly' ? '' : `-${end_dateDate}`}`} {time_chk == 'monthly' || time_chk == 'yearly' || time_chk == 'week' || time_chk == 'day' ? '' : `(${endtime})`} <ArrowDropDownIcon style={{ marginLeft: '10px' }} /></button>
                                                    ...
                                                    <div onMouseEnter={() => {
                                                        ...
                                                        <div style={{ width: page === 1 ? '350px' : '420px', borderRadius: '5px', backgroundColor: '#181828', padding: '10px', position: 'absolute', top: page === 1 ? '80px' : '60px', zIndex: 1, boxShadow: 'rgba(0, 0, 0, 0.35) 0px 5px 15px', display: btn1 === 'day' || btn1 === 'week' ? 'block' : 'none' }}>
                                                            <div style={{ position: 'relative' }}>
                                                                    ...
                                                                    <div style={{ display: 'flex', padding: '10px', flexDirection: 'column' }}>
                                                                        ...
                                                                        <div style={{ position: 'relative' }}>
                                                                            <div style={{ backgroundColor: '#f4f7fa', borderRadius: '5px', padding: '10px', display: 'flex', justifyContent: 'space-between' }} onClick={() => {
                                                                                ...
                                                                                <p style={{ fontWeight: 'bolder', margin: 0, color: '#181828' }}>{`${start_dateFullYear}${time_chk != 'yearly' ? `-${start_dateMonth}` : ''}${time_chk == 'monthly' || time_chk == 'yearly' ? '' : `-${start_dateDate}`}`} {time_chk == 'monthly' || time_chk == 'yearly' || time_chk == 'day' || time_chk == 'week' ? '' : <span style={{ marginLeft: '10px' }}>{`${starttime}-${endtime}`}</span>}</p>
                                                                            ...
                                                                            <div style={{ position: 'absolute', zIndex: 2, top: '50px', display: viewstart_date === true ? 'block' : 'none' }}>
                                                                                <DateComponent year={start_dateFullYear} month={Number(start_dateMonth)} date={Number(start_dateDate)} type={'start_date'} starttime={starttime} endtime={endtime} parentFunction={initialdate} flag={'endTime'} select_hour={'none'} apply_can_fun={apply_can_fun} days_time={time_chk == 'monthly' || time_chk == 'yearly' ? false : true} time_chk={time_chk} />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                            ...
                                                                            <div style={{ display: 'flex', padding: '10px', flexDirection: 'column' }}>
                                                                                ...
                                                                                <div style={{ position: 'relative' }}>
                                                                                    <div style={{ backgroundColor: '#f4f7fa', borderRadius: '5px', padding: '10px', display: 'flex', justifyContent: 'space-between' }} onClick={() => {
                                                                                        ...
                                                                                        <p style={{ fontWeight: 'bolder', margin: 0, color: '#181828' }}>{`${end_dateFullYear}${time_chk != 'yearly' ? `-${end_dateMonth}` : ''}${time_chk == 'monthly' || time_chk == 'yearly' ? '' : `-${end_dateDate}`}`} {time_chk == 'monthly' || time_chk == 'yearly' || time_chk == 'day' || time_chk == 'week' ? '' : <span style={{ marginLeft: '10px' }}>{`${starttime}-${endtime}`}</span>}</p>
                                                                                        <CalendarMonthIcon style={{ cursor: 'pointer', color: '#181828' }} />
                                                                                    </div>

                                                                                    <div style={{ position: 'absolute', zIndex: 2, top: '50px', display: viewend_date === true ? 'block' : 'none' }}>
                                                                                        <DateComponent year={end_dateFullYear} month={Number(end_dateMonth)} date={Number(end_dateDate)} type={'end_date'} starttime={starttime} endtime={endtime} parentFunction={initialdate} flag={'endTime'} select_hour={'none'} apply_can_fun={apply_can_fun} days_time={time_chk == 'monthly' || time_chk == 'yearly' ? false : true} time_chk={time_chk} />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            : ''
                                    ...
                                    <Row>
                                        {
                                            console.log(selected_cameras, cameras)
                                        }

                                        {
                                            selected_cameras.length != 0 && cameras.length != 0 ?
                                                <Col xl={12} lg={12} md={12} sm={12} xs={12}>
                                                    <List_comp startdate={startdate} starttime={starttime} enddate={enddate} endtime={endtime} time_chk={time_chk} />
                                                </Col>
                                                : res_flag == 'no res' ?
                                                    <Col xl={12} lg={12} md={12} sm={12} xs={12}>
