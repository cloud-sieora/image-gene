...
export default function PersonList() {
    ...
    console.log('faceImagesFromFast', faceImagesFromFast)

    function result_prediction_image(image_path, site_id) {
        for (let index = 0; index < site_id.length; index++) {
            axios.post('http://10.147.21.167:5000/Face_Search_Api', JSON.stringify({
                data: {
        ...
        <div onClick={(event) => {
            ...
            <div>
...

                {
                    ...
                    //                                                     document.getElementById(`edit_upload`).click()
                    //                                                 }}>
                    //                                                     <input id={`edit_upload`} name="upload" type="file" hidden
                    //                                                         onChange={(event) => {
                    ...
                    //                                                                         const params = {
                    //                                                                             topic: `search_face`,
                    //                                                                             payload: JSON.stringify({ image_key: `${date}.jpg`, id: date }),
                    //                                                                             qos: 0
                    //                                                                         };
                    ...
                    //                                                                         function get_face_id() {
                    //                                                                             const options = {
                    //                                                                                 url: api.LIST_FACE_SEARCH_ID,
                    //                                                                                 method: 'POST',
                    //                                                                                 headers: {
                    //                                                                                     'Content-Type': 'application/json',
                    //                                                                                 },
                    //                                                                                 data: JSON.stringify({ search_id: date })
                    //                                                                             };
                    //                                                                             axios(options)
                    //                                                                                 .then((res) => {
                    //                                                                                     console.log(res.data);
                    ...
                    //                                                                                         axios.delete(`${api.CREATE_FACE_SEARCH_ID}${res.data[0]._id}`)
                    //                                                                                             .then((response) => {
                    //                                                                                                 if (res.data[0].face_id != 'NONE' && res.data[0].face_id != '') {
                    //                                                                                                     setface_id(res.data[0].face_id)
                    //                                                                                                     list_camera_site_id(selected_sites, res.data[0].face_id)
                    //                                                                                                 } else {
                    //                                                                                                     setface_id('None')
                    //                                                                                                     list_camera_site_id(selected_sites, 'None')
                    //                                                                                                 }
                    //                                                                                             }).catch((e) => {
                    //                                                                                                 console.log(e);
                    //                                                                                             })
                    ...
                    //                                     image_url != 'None' ?
                    //                                         <div style={{ position: 'relative' }}>
                    //                                             <img src={URL.createObjectURL(image_url)} alt="Selected" style={{ width: '100%' }} />
                    ...
                    //                                                                 }}></input></th>
                    //                                                                 <td style={{ padding: '15px' }}>{val.name}</td>
                    //                                                                 <td style={{ padding: '15px' }}>{val.user_id}</td>
                    //                                                                 <td style={{ padding: '15px' }}>{val.list_type}</td>
                    //                                                                 <td style={{ padding: '15px' }}>{val.date}</td>
                    //                                                                 <td style={{ padding: '15px' }}>{val.time}</td>
                    //                                                                 <td style={{ padding: '15px' }}><img crossorigin="anonymous" width="100%" height="100%" src={val.image_url}></img></td>
                    //                                                             </tr>
                    //                                                         )
                    //                                                     })
                    //                                                     : ''
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            {
                                selectedType === 'face' ?
                                    <div style={{ display: 'flex', alignItems: 'center', height: '100%', width: '30%', backgroundColor: '#eaecee', borderRadius: '10px', padding: '5px 10px', justifyContent: 'space-evenly' }}>
                                        <div style={{ display: 'flex', marginRight: '5px' }}>
                                            <input
                                                type='radio'
                                                name='face_info'
                                                value='OTHERS'
                                                checked={face_info === 'OTHERS'}
                                                onChange={() => setface_info('OTHERS')}
                                            />
                                            <p style={{ margin: 0, marginLeft: '5px', fontSize: '12px' }}>OTHERS</p>
                                        </div>
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center' }}>
                                            <input
                                                ...
                                                name='face_info'
                                                value='CCTV'
                                                checked={face_info === 'CCTV'}
                                                onChange={() => setface_info('CCTV')}
                                            />
                                            <p style={{ margin: 0, marginLeft: '5px', fontSize: '12px' }}>CCTV</p>
                                        </div>
                            ...
                            <div style={{
                                backgroundColor: isRecording !== true ? '#eaecee' : '#f5b7b1',
                        ...
                        <textarea
                            ...
                            style={{
                                ...
                                width: '100%',
                                height: '75%',
                                resize: 'none', // Optional: To disable resizing if needed
                                textAlign: 'start', // Ensures the text is aligned at the top
                                verticalAlign: 'top', // Ensures the text is vertically aligned at the top
                            }}
                        />
                    </div>
                    ...
                    >
                        ...
                        {/* Display uploaded image or prompt if no image */}
                        {
                            imagePreview ? (
                                <div style={{ width: '100%', height: '100%', position: 'relative' }}>
                                    ...
                                    <div style={{
                                        ...
                                        onClick={(e) => {
                                            e.stopPropagation(); // Prevent triggering file input when clicking the close button
