...
export default function Index() {
    ...
    const [over_image_array, setover_image_array] = useState([{ img_arr: [] }])
            ...
            try {
                socket.on('camera_mp', function (a) {
                    ...
                    if (save_type == 'new_data') {
                        new_cam_data.map((val, i) => {
                            if (val.main_stream == JSON.parse(a).rtsp) {
                                new_cam_data[i].camera_mp = JSON.parse(a).camera_mp
                                new_cam_data[i].ip_address = JSON.parse(a).ip_address
                                new_cam_data[i].user_name = JSON.parse(a).user_name
                                new_cam_data[i].password = JSON.parse(a).password
                            }
                        })
                        setAddCameraMannullyArray(new_cam_data)
                    } else {
                        new_cam_data.map((val, i) => {
                            if (val.main_stream == JSON.parse(a).rtsp) {
                                new_cam_data[i].camera_mp = JSON.parse(a).camera_mp
                                new_cam_data[i].ip_address.select = JSON.parse(a).ip_address
                                new_cam_data[i].user_name = JSON.parse(a).user_name
                                new_cam_data[i].password = JSON.parse(a).password
                            }
                        })
                        console.log(new_cam_data)
                        setcamera_object(new_cam_data)
                    }
                                            ...
                                            <Col xl={12} lg={12} md={12} sm={12} xs={12}>
                                                <div>
                                                    <div style={{ backgroundColor: '#181828', padding: '10px', display: 'flex', alignItems: 'flex-end' }}>
                                                        ...
                                                        {
                                                            // analytic_type == 'people_masking' ?
                                                            //     <div>
                                                            //         <div>
                                                            //             <div>
                                                            //                 <p style={{ color: 'white', marginBottom: '5px' }}>Gender</p>
                                                            //                 <div style={{ backgroundColor: gender_value != false ? '#42cf10' : '#a8a4a4', width: '3rem', height: '1.5rem', borderRadius: '15px', display: 'flex', justifyContent: gender_value != false ? 'flex-end' : 'flex-start', alignItems: 'center', padding: '2px' }} onClick={() => {
                                                            //                     let data = over_image_array
                                                            //                     let newdata = []
                                                            //                     data.map((da, i) => {
                                                            //                         if (da.id == alert_value._id) {
                                                            ...
                                                            //                             da.img_arr.map((value, k) => {
                                                            //                                 if (value.flag == true) {
                                                            //                                     newdata[i].img_arr[k].gender = !gender_value
                                                            //                                 }
                                                            //                             })
                                                            //                         } else {
                                                            //                             newdata.push(da)
                                                                        ...
                                                                        <CloseIcon style={{ fontSize: '15px', cursor: 'pointer' }} onClick={() => {
                                                                            ...
                                                                            over_image_array.map((arr, v) => {
                                                                                if (alert_value._id == arr.id) {
                                                                                    ...
                                                                                    if (newone.length != 0) {
                                                                                        newone[0].flag = true
                                                                                        get_image_url(newone[0].url)
                                                                                        setmask_range_name(newone[0].name)
                                                                                        setdirection_name(newone[0].direction)
                                                                                        setin_out(newone[0].sequence)
                                                                                        setfrom_time(newone[0].from_time)
                                                                                        setto_time(newone[0].to_time)
                                                                                        settype(newone[0].type)
                                                                                        setclass_name(newone[0].class)
                                                                                        setthreshold(newone[0].threshold)
                                                                                    }
                                                                                } else {
                                                                                    newdata.push(arr)
                                                                                }
                                                    ...
                                                    {
                                                        over_image_array[0].img_arr.length == 0 ?
                                                            ...
                                                            :
                                                            <MaskSelection image_edited={edit_image} data1={alert_value} camera_name={alert_value.camera_gereral_name} mask1={mask_image} p={0} type='one_mask' analytic_type={analytic_type} over_image_array={over_image_array} fun_over_image_array={fun_over_image_array} second_flag={second_flag} save_trigger={save_trigger} />
                                                    }
                                                </div>
                                            </Col>
                                        </Row>
                                                            ...
                                                            <div>
                                                                {
                                                                    addCameraMannullyArray.map((d, i) => (
                                                                        <Row style={{ padding: '10px', alignItems: 'center', backgroundColor: 'white' }} key={i} >
                                                                            ...
                                                                            <Col xl={6} lg={6} md={6} sm={12} xs={12}>
                                                                                <div>
                                                                                    ...
                                                                                    <input type='text' disabled={d.device_id.deviceName != '' ? false : true} placeholder='Enter Ip Address' style={{ backgroundColor: '#e6e8eb', color: 'black', padding: '10px', borderRadius: '5px', border: '1px solid gray', marginRight: '20px', width: '100%', fontSize: '14px' }} onChange={(e) => {
                                                                                        ...
                                                                                        let filterArray = addCameraMannullyArray.filter((ele) => ele.cameraId !== d.cameraId)
                                                                                        let value = e.target.value
                                                                                        filterArray.splice(index, 0, { ...findArray, main_stream: value, live_uri: value })
                                                                                        new_cam_data = filterArray
                                                                                        setAddCameraMannullyArray(filterArray)
                                                                                    }} onBlur={() => {
                                                                                        AWS.config.update({
                                                                                            region: 'ap-south-1', // e.g., 'us-east-1'
                                                                            ...
                                                                            <Col xl={6} lg={6} md={6} sm={12} xs={12}>
                                                                                <div>
                                                                                    <p style={{ color: 'black', marginTop: '5px', marginBottom: '5px' }}>Sub Stream</p>
                                                                                    <input type='text' disabled={d.device_id.deviceName != '' ? false : true} placeholder='Enter Ip Address' style={{ backgroundColor: '#e6e8eb', color: 'black', padding: '10px', borderRadius: '5px', border: '1px solid gray', marginRight: '20px', width: '100%', fontSize: '14px' }} onChange={(e) => {
                                                                                        let findArray = addCameraMannullyArray.find((ele) => ele.cameraId === d.cameraId)
                                                                                        let index = addCameraMannullyArray.indexOf(findArray)
                                                                                        let filterArray = addCameraMannullyArray.filter((ele) => ele.cameraId !== d.cameraId)
                                                ...
                                                <Row>
                                                    <Col xl={12} lg={12} md={12} sm={12} xs={12}>
                                                        <button style={{ backgroundColor: '#e22747', color: 'white', border: 'none', borderBottomLeftRadius: '5px', borderBottomRightRadius: '5px', width: '100%', padding: '5px' }} onClick={() => {
                                                            console.log("total Data, Add camera button clicked", subscriptionPlanData[0].sub.start_time)
                                                                    ...
                                                                    if (addCameraMannullyArray[check].camera_mp !== 0) {
                                                                        for (let index = 0; index < subscriptionPlanData.length; index++) {
                                                                            if (addCameraMannullyArray[check].camera_mp === 2 && subscriptionPlanData[index].cameras_for_add._2mp > 0) {
                                                                                ...
                                                                                if (addCameraMannullyArray[check].camera_mp == false || addCameraMannullyArray[check].camera_mp == 0 || addCameraMannullyArray[check].camera_mp == '') {
                                                                ...
                                                                if (checkFlag && alert_str == '' && available_str == '') {
                                                                    addCameraMannullyArray.map((value) => {
                                                                        const device_details = {
                                                                            ...
                                                                            "plan_start_time": value.plan_start_time,
                                                                            ...
                                                                            // 'updated_time': moment(new Date()).format('HH:MM:ss'),
                                                                            "Active": value.active === "active" ? 0 : 1,
                                                                            "client_admin_id": (JSON.parse(localStorage.getItem("userData"))).position_type == 'Client Admin' ? (JSON.parse(localStorage.getItem("userData")))._id : (JSON.parse(localStorage.getItem("userData"))).client_admin_id,
                                                                            "site_admin_id": (JSON.parse(localStorage.getItem("userData"))).position_type == 'Site Admin' ? (JSON.parse(localStorage.getItem("userData")))._id : (JSON.parse(localStorage.getItem("userData"))).site_admin_id,
                                                                            "clientt_id": (JSON.parse(localStorage.getItem("userData"))).position_type == 'Client' ? (JSON.parse(localStorage.getItem("userData")))._id : (JSON.parse(localStorage.getItem("userData"))).clientt_id,
                                                                        };
                                            ...
                                            <button style={{ backgroundColor: '#e22747', color: 'white', border: 'none', borderBottomLeftRadius: '5px', borderBottomRightRadius: '5px', width: '100%', padding: '5px' }} onClick={() => {
                                                if (isPlanSelected) {
                                                    if (userSelectedPlan.cameras_options.alert > 0) {
                                                        ...
                                                        alert_value.camera_option = { ...alert_value.camera_option }
                    ...
                    <select name="people_seq" id="people_seq" onChange={(e) => {
                        ...
                        <option value="Out">Out</option>
                            ...
                            <Modal
                                ...
                                aria-labelledby="modal-modal-title"
                                aria-describedby="modal-modal-description"
                                style={{ marginLeft: 'auto', marginRight: 'auto', maxHeight: '80%', width: '50%', top: 20, zIndex: 1 }}
                            >
                                                    ...
                                                    <Col xl={12} lg={12} md={12} sm={12} xs={12}>
                                                        <button style={{ backgroundColor: '#e22747', color: 'white', border: 'none', borderBottomLeftRadius: '5px', borderBottomRightRadius: '5px', width: '100%', padding: '5px' }} onClick={() => {
                                                            ...
                                                            for (let check = 0; check < camera_object.length; check++) {
                                                                if (camera_object[check].name !== '' && camera_object[check].site !== '' && camera_object[check].active !== '' && camera_object[check].main_stream !== '' && camera_object[check].sub_stream !== '') {
                                                                    checkFlag = true
                                                                    let plan_flag = false
                                                                    console.log(camera_object[check].camera_mp, camera_object[check].main_stream, selectedcameras[check].camera_url)
                                                                    if (camera_object[check].camera_mp !== 0 && camera_object[check].main_stream !== selectedcameras[check].camera_url) {
                                                                        for (let index = 0; index < subscriptionPlanData.length; index++) {
                                                                            if (camera_object[check].camera_mp === 2 && subscriptionPlanData[index].cameras_for_add._2mp > 0) {
                                                                                ...
                                                                                if (camera_object[check].camera_mp == false) {
                                                                                    available_str = `${available_str}, ${camera_object[check].name} `
                                                                                } else {
                                                                                    plan_flag = false
                                                                                }
                                                                            }
                                                                        ...
                                                                        if (!plan_flag) {
                                                                            alert_str = `${alert_str}, ${camera_object[check].camera_mp} `
                                                                        }
                                                                    }
                                                                } else {
                                                                    checkFlag = false
                                                                ...
                                                                <Col xl={12} lg={12} md={12} sm={12} xs={12} style={{ overflowX: 'scroll' }}>
                                                                    <table style={{ width: '100%', backgroundColor: 'white' }}>
                                                                        <tr style={{ backgroundColor: '#e6e8eb', color: 'black', }}>
                                                                            ...
                                                                            <th style={{ padding: '15px' }}>Queue Analytics</th>
                                                                            <th style={{ padding: '15px' }}>Device id</th>
                                                                            <th style={{ padding: '15px' }}>Tags</th>
                                                                            <th style={{ padding: '15px' }}>Groups</th>
                                                                        </tr>
