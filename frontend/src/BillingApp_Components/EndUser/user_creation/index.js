...
export default function Device_list() {
    ...
    const [alert_noti, setalert_noti] = useState(false)
    ...
    function searchfunction(event, data, type) {
        ...
        if (event !== '') {
            ...
            //         return  d.user_type.toUpperCase().includes(str.toUpperCase())
            //         || d.mail.toUpperCase().includes(str.toUpperCase())
            //         || d.User_name.toUpperCase().includes(str.toUpperCase())
            //         || d.client_id.toUpperCase().includes(str.toUpperCase())
            //         || d.mobile_number.toUpperCase().includes(str.toUpperCase())
            //     })
            //     console.log("filtered Data", filteredData)
            //     setuser_list(filteredData)
                    ...
                    <Row style={{ padding: '0px', alignItems: 'center', }}>
                        <Col xl={12} lg={12} md={12} sm={12} xs={12}>
                            <div style={{ backgroundColor: '#e22747', color: 'white', display: 'flex', justifyContent: 'space-between', padding: '10px', alignItems: 'center' }}>
                                ...
                                <CloseIcon style={{ fontSize: '15px', cursor: 'pointer', cursor: 'pointer' }} onClick={() => {
                                    handleClose()
                                }} />
                            </div>
                        </Col>
                    ...
                    <Row style={{ padding: '10px', alignItems: 'center', }}>
                        ...
                        <Col xl={6} lg={6} md={6} sm={12} xs={12}>
                            <div style={{ marginTop: '5px' }}>
                                ...
                                <input type='text' placeholder='Enter User Id' value={user_id} style={{ backgroundColor: '#e6e8eb', color: 'black', padding: '10px', borderRadius: '5px', border: '1px solid gray', marginRight: '20px', width: '100%', fontSize: '14px' }} onChange={(e) => { setuser_id(e.target.value) }}></input>
                            </div>
                        </Col>
                                    ...
                                    }}>
                                        {
                                            operation_type.length != 0 ?
                                                operation_type.map((value) => (
                                                    <span style={{ backgroundColor: '#e6e8eb', color: 'black', padding: '5px', borderRadius: '20px', border: '1px solid gray', marginRight: '10px', display: 'flex', alignItems: 'center', fontSize: '13px' }}> {value} <CloseIcon style={{ color: 'black', fontSize: '15px', cursor: 'pointer', marginLeft: '5px', cursor: 'pointer' }} onClick={() => {
                                                        let data = []
                                    ...
                                    <div id='user_type' style={{ backgroundColor: '#e6e8eb', width: '100%', padding: '15px', borderRadius: '5px', position: 'absolute', display: 'none', maxHeight: '100px', overflowY: 'scroll' }}>
                                        {
                                            userData.position_type == 'Client' ?
                                                <div>
                                                    ...
                                                    <hr></hr>
                                                    <p style={{ padding: '0', margin: 0, cursor: 'pointer', color: user_type == 'Attendance User' ? 'blue' : '' }} onClick={() => {
                                                        document.getElementById('user_type').style.display = 'none'
                                                        setuser_type('Attendance User')
                                                    }}>Attendance User</p>
                                                </div>
                                        ...
                                        <div style={{ position: 'relative', zIndex: 1 }}>
                                            <p type='text' style={{ backgroundColor: '#e6e8eb', color: 'black', padding: '8px', borderRadius: '5px', border: '1px solid gray', marginRight: '20px', width: '100%', display: 'flex', overflowX: 'scroll', cursor: 'pointer', marginBottom: 0 }} onClick={() => {
                                                if (document.getElementById('select_site').style.display !== 'none') {
                                                    ...
                                                    site.length != 0 ?
                                                        site.map((value) => (
                                                            <span style={{ backgroundColor: '#e6e8eb', color: 'black', padding: '5px', borderRadius: '20px', border: '1px solid gray', marginRight: '10px', display: 'flex', alignItems: 'center', fontSize: '13px' }}> {value.site_name} <CloseIcon style={{ color: 'black', fontSize: '15px', cursor: 'pointer', marginLeft: '5px', cursor: 'pointer' }} onClick={() => {
                                                                let data = []
                                                ...
                                                handleOpen1()
                                                    ...
                                                    camera_ids.length != 0 ?
                                                        camera_ids.map((value) => (
                                                            value.type !== 'empty' ?
                                                                <span style={{ backgroundColor: '#e6e8eb', color: 'black', padding: '5px', borderRadius: '20px', border: '1px solid gray', marginRight: '10px', display: 'flex', alignItems: 'center', fontSize: '13px', whiteSpace: 'nowrap' }}> {value.camera_name} <CloseIcon style={{ color: 'black', fontSize: '15px', cursor: 'pointer', marginLeft: '5px', cursor: 'pointer' }} onClick={() => {
                                                                    handleOpen1()
                                                                }}></CloseIcon></span>
                                                                : null
                                                        ))
                        ...
                        <Col xl={4} lg={4} md={4} sm={12} xs={12}>
                            ...
                            <div style={{ marginTop: '10px' }}>
                                ...
                                <div style={{ backgroundColor: alert_noti == true ? '#e32747' : '#a8a4a4', width: '3rem', height: '1.5rem', borderRadius: '15px', display: 'flex', justifyContent: alert_noti == true ? 'flex-end' : 'flex-start', alignItems: 'center', padding: '2px' }} onClick={() => {
                            ...
                            <button style={{ backgroundColor: '#e22747', color: 'white', border: '1px solid grey', borderRadius: '5px', padding: '5px', marginTop: '15px', marginRight: '15px' }} onClick={() => {
                                if (
                                    ...
                                    const client_admin_details = {
                                        ...
                                        user_type: 'User',
                                        site_id: site,
                                        alert_noti: alert_noti == true ? 1 : 0,
                                        camera_id: cam_list,
                                        ...
                                        admin_owner_id:userData.admin_owner_id
                                    };
                ...
                <Col xl={12} lg={12} md={12} sm={12} xs={12}>
                    {
                        skeleton ? (
                            <div style={{ display: 'flex' }}>
                                <input type='text' placeholder='Searchh' style={{ backgroundColor: '#e6e8eb', color: 'black', padding: '10px', borderRadius: '20px', border: '1px solid gray', marginRight: '20px', }}
                                    onChange={(e) => {
                                        if (e.target.value !== '') {
                                ...
                                }}> <PermIdentityOutlinedIcon style={{ marginRight: '10px' }} />Add User</button>
                            </div>
                        ) : (
...

                                {
                                    user_list.map((val, i) => (
                                        <tr style={{ borderBottom: '1px solid grey', color: 'black' }}>
                                            ...
                                            <td style={{ padding: '15px', color: val.operation_type != 'Read Only' ? '#1ee01e' : 'red' }}>{
                                                val.operation_type.length > 1 ?
                                                    `${val.operation_type[0]}, ${val.operation_type[1]}`
                                                    :
                                                    val.operation_type
                                            }</td>
                                                ...
                                                <div style={{ display: 'flex' }}>
                                                    <div style={{ backgroundColor: '#e22747', border: '1px solid grey', borderRadius: '5px', marginRight: '5px', cursor: 'pointer' }} onClick={() => {
                                                        ...
                                                        if (userData.position_type == 'Client Admin' || userData.position_type == 'Client') {
                                                            ...
                                                            setuser_id(val.client_id)
                                                            setuser_name(val.User_name)
                                                            setalert_noti(val.alert_noti == 0 ? false : true)
                                                            setpassword(val.password)
                                                            setmobile_number(val.mobile_number)
                                                            setmail_id(val.mail)
                                                            setactive(val.Active)
