...
export default function PersonList() {
    ...
    function list_camera_site_id(site_id, face_id) {
        ...
        for (let index = 0; index < site_id.length; index++) {
            const getStocksData = {
                url: api.ANPR_LIST_SITE_DATE_TIME,
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    return (
        ...
        }} style={{ backgroundColor: 'white', borderRadius: '5px', height: '95vh', overflowY: 'scroll', overflowX: 'hidden' }}>
            <div>
